...
total_recipe_time_based_on_steps = my_recipe.total_step_time
  ...
  it "should have a intitial user estimated total recipe time that is overwritten by the actual recipe time as user adds each recipe steps with their individual times" do
